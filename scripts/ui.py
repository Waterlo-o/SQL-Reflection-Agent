...
st.markdown("Задай вопрос на естественном языке, а агент сам напишет SQL-запрос, проверит его и выдаст ответ.")

user_question = st.text_input("Ваш вопрос к базе данных:", placeholder="Например: Сколько всего клиентов в базе?")
